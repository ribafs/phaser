class Scene01 extends Phaser.Scene{
	...
	create(){
		...
		.setCollideWorldBounds(true) // Colidir com os limites da cena/mundo
		.setScale(2) // 2 é o mesmo que 2,2
		.setBounce(.4)
		this.player.canJump = true
		this.player.body.setSize(16,32)		
		
		this.control = this.input.keyboard.createCursorKeys() // Cria objeto para disparar o movimento pelas setas do teclado
		
		this.platforms = this.physics.add.staticGroup()
		this.platforms.create(0,600,'platform')
		.setScale(2.5,1)
		.setOrigin(0,1) // Mudar o ponto de ancoragem da imagem/objeto
		.refreshBody() // como é um objeto estático precisamos atualizar suas propriedades após qq alteração
